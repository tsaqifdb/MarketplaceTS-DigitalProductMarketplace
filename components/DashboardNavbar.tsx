    ...
    <nav className="bg-white border-b border-emerald-200 px-6 py-4 shadow-sm">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center me-0">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown menu */}
            {isDropdownOpen && (
              <div className="absolute right-0 mt-4 w-52 bg-white/80 backdrop-blur-md border border-gray-200/50 rounded-2xl shadow-2xl z-50 animate-in fade-in slide-in-from-top-5 duration-300 mr-4">
