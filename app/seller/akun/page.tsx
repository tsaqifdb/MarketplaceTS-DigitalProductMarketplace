...
export default function SellerAkunPage() {
  const { user } = useAuth();
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Setelan Akun Seller</h1>
              <p className="mt-1 text-sm text-gray-600">
                Kelola informasi profil dan pengaturan akun penjual Anda
              </p>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Poin Seller</label>
                        <div className="text-gray-900 p-2 bg-gray-50 rounded-md">{user?.sellerPoints || '0'}</div>
                      </div>
