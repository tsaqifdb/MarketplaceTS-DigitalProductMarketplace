...
export default function UnauthorizedClient() {
  ...
  useEffect(() => {
    if (user?.role) {
      ...
      switch (user.role) {
        ...
        case 'curator': redirectPath = '/curator'; break;
        case 'seller': redirectPath = '/seller'; break;
        default: redirectPath = '/dashboard'; break;
      }
  ...
  const getSuggestedPages = (role: string) => {
    ...
    return pages[role] || [{ name: 'Dashboard', path: '/dashboard' }];
  };
